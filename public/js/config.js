...
export const LEVELS = {
  ...
  mix:     { label: '섞어서',        desc: '두 묶음을 합쳐 사람마다 무작위로 (어른·아이 함께할 때)' },
};

// 시작 화면 이야기 — 왜 하는지, 괴물은 무엇인지, 우리는 무엇으로 이기는지
export const STORY = {
  title: '어느 날, 화면 너머에서',
  lines: [
    'AI가 하루가 다르게 똑똑해지는 사이, 우리 화면에는 이상한 것들이 하나씩 늘었어요. 그럴듯한 거짓말, 진짜 같은 가짜 얼굴, 보고 싶은 것만 보여 주는 거품.',
    '이 혼란을 즐기는 자가 있어요. 디지털 혼란의 근원, <b>대마왕 글리치</b>. 글리치는 네 마리 부하를 세상에 풀어놓았어요.',
    '부하들은 <b>모르는 사람에게만</b> 힘을 씁니다. 원리를 알면 힘을 잃고, 여럿이 함께 알면 아예 버티지 못해요.',
    '그래서 열 개 커뮤니티가 한 원정대가 되었어요. 하루 한 조각씩 배우고, 배운 것으로 공격합니다. <b>아는 만큼 힘이 된다</b> — 이것이 우리의 무기예요.',
  ],
  foes: [
    { id: 'bugbug',  name: '버그벌레',   why: '1947년 컴퓨터 속에서 진짜 나방이 나와 "첫 버그"로 기록됐어요. 컴퓨터가 어떻게 일하는지 알면 오류가 무섭지 않아요.' },
    { id: 'doppel',  name: '도플갱어',   why: '"똑같이 생긴 가짜"라는 뜻이에요. 딥페이크와 사칭을 가려내는 눈을 기르면 물리칠 수 있어요.' },
    { id: 'halluci', name: '할루시',     why: 'AI가 없는 사실을 지어내는 "환각(할루시네이션)"에서 온 이름이에요. 출처를 확인하는 습관에 약해요.' },
    { id: 'bubble',  name: '필터버블',   why: '알고리즘이 만든 거품에 사람을 가둬요. 서로 다른 생각이 모이면 거품은 터집니다.' },
    { id: 'glitch',  name: '대마왕 글리치', why: '화면이 깨질 때의 그 "글리치"예요. 네 부하를 모두 물리치고 모은 봉인 조각으로만 쓰러뜨릴 수 있어요.' },
  ],
};
...
export const TEAMS = [
  ...
  { id: 'h2o',       community: 'H2O',            monster: '또롱이',   color: '#3fc6d8', desc: '맑은 물방울 속에 따뜻한 마음을 품은 요정',
    ...
    skill: { key: 'wave',   name: '마음의 물결',   effect: '응원 풍선 효과가 2배로 오래감' } },
];
